...
@Service
@Transactional
public class ProfileUpdateService extends AbsUtilService {
    ...
    public void mainProcess() {
        ...
        // 更新処理が完了したメッセージを詰める
        String successMsg = "プロフィールの更新が完了しました。";
        this.redirectAttributes.addFlashAttribute("successMsg", successMsg);
